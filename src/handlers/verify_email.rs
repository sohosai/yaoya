...
pub fn username_error_to_error_message( e: UsernameError,params: &EmailVerificationOptions,)-> Message  // Title,subtitle,description{{
 {
    let text = match e{
...
pub fn username_to_confirmation_message(username: Username,params: &EmailVerificationOptions)-> Result<Message,warp::reply::Html<String>>{
